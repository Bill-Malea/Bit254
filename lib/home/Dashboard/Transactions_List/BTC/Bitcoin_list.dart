...
class EtheriumTransactionList extends StatefulWidget {
  @override
  _BitcoinTransactionListState createState() => _BitcoinTransactionListState();
}

class _BitcoinTransactionListState extends State<EtheriumTransactionList> {
  @override
    ...
    return ListView.builder(
        ...
        itemBuilder: (ctx, index) {
          ...
          final _time = _transactions[index].date.substring(8, 10) +
              ':' +
              _transactions[index].date.substring(10, 12); //.split(':')[2];

          // print(_transactions[index].date);
